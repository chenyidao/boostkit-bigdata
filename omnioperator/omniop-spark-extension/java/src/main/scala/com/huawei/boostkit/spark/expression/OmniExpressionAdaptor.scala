...
object OmniExpressionAdaptor extends Logging {
  ...
  def toOmniAggFunTypeWithFinal(agg: AggregateExpression, isHashAgg: Boolean = false, isFinal: Boolean): FunctionType = {
  ...
  def toOmniAggFunType(agg: AggregateExpression, isHashAgg: Boolean = false): FunctionType = {
    toOmniAggFunTypeWithFinal(agg, isHashAgg, false)
  }
